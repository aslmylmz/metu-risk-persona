...
%
%  Compiles with pdfLaTeX on Overleaf. Build sequence:
%      pdflatex paper  ->  bibtex paper  ->  pdflatex paper  ->  pdflatex paper
%  Requires paper.bib in the same directory.
%
%  This paper follows the structure required by the Journal of Open Source
%  Software (Summary, Statement of need, ...). Note: JOSS itself ingests the
%  Markdown source (paper.md); this .tex is the human-readable / Overleaf
